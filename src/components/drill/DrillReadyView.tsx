    ...
    <SafeAreaView style={styles.wrap}>
      ...
      <View style={styles.center}>
        ...
        <Text style={styles.tip}>
          Put your headphones in. On iPhone, make sure the silent switch is OFF so cues are audible.
        </Text>
      </View>
...
const styles = StyleSheet.create({
  wrap: { flex: 1, backgroundColor: colors.background, paddingHorizontal: spacing.lg, paddingBottom: spacing.lg },
  back: { paddingVertical: spacing.md },
  backLabel: { ...typography.subtitle, color: colors.textSecondary, fontWeight: '700' },
  ...
  testLabel: { ...typography.subtitle, color: colors.textPrimary, fontWeight: '700' },
  tip: { ...typography.caption, color: colors.textMuted, textAlign: 'center', marginTop: spacing.md, paddingHorizontal: spacing.lg },
});
